...
public class Renderer {
    ...
    public static void Render(WorldObject Object) {
        ...
        if (Object.Instanced) {
            ...
            glDrawElementsInstanced(GL_TRIANGLES, Object.Mesh.Indices.length, GL_UNSIGNED_INT, 0, Object.InstanceCount);
            glDisableVertexAttribArray(3);
        }
        else {
            glDrawElements(GL_TRIANGLES, Object.Mesh.Indices.length, GL_UNSIGNED_INT, 0);
        }
